...
export const selectRotorButton = (id: number): string => `${SET_ROTOR_BUTTON}${id}`;
export const letterButton = (letter: string, rotorId: number): string => `${BUTTON}${letter}${rotorId};`
