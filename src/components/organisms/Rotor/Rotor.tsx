...
import { ChangeIndexModal } from '../../molecules/ChangeIndexModal';
import { RotorSelectModal } from '../../molecules/RotorSelectModal';
...
export const Rotor: FunctionComponent<RotorProps> = ({ slotIndex }) => {
  ...
  return (
    <View>
      ...
      <Card style={styles.rotor} contentStyle={{ paddingHorizontal: 0 }}>
        {selectedRotor && (
          <View>
            <Card.Title
              title={currentLetter(
            ...
            />
            <Card.Actions style={styles.cardComponent}>
              <Button
